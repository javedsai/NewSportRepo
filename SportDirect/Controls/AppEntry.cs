...
namespace SportDirect.Controls
{
    public class AppEntry : Entry
    {
        ...
        {
            //base.Focused += (object sender, FocusEventArgs e) =>
            //{
            //    this.BorderColor = (Color)App.AppInstance.Resources["AccentColor"];
            //};
            //base.Unfocused += (object sender, FocusEventArgs e) =>
            //{
            //    this.BorderColor = (Color)App.AppInstance.Resources["DefaultBorderColor"];
            //};
        }
